...
const PRESET_NAMES = {
  ...
  saitama: {
    ...
    kuyo: ["木津伊美子", "木津俊信", "木津洋三", "木津妙子", "木津思音", "相田八重子", "高柳麻理子", "田邊貴章", "須黒安子", "清水みさほ", "堀越文子", "上原正樹", "上原広樹", "仲間まゆみ", "福田里菜", "福田優", "Alec純Blum", "小田嶋基就", "田中良実", "田中誠", "田中陽斗", "中村光子", "金城邦枝", "沖津玲那", "石川大輔", "相原久子", "山田幸世", "山田智", "山田裕生", "榎本圭吾", "矢代初枝", "矢代吉榮", "矢代順子", "矢代海斗"],
  },
  chiba: {
...
const PARTICIPANT_NAME_CORRECTIONS = {
  ...
  柏木マリヱ: "柏木マリヱ", 柏木マリエ: "柏木マリヱ", "岡﨑千帆": "岡崎千帆", 岡崎千帆: "岡崎千帆", 矢代海斗34: "矢代海斗", 三上結奈: "三上結菜",
  西野玲那: "沖津玲那", 西野玲奈: "沖津玲那", "沖津(西野)玲那": "沖津玲那", "沖津（西野）玲那": "沖津玲那", "沖津(西野)玲奈": "沖津玲那", "沖津（西野）玲奈": "沖津玲那", 沖津玲那: "沖津玲那", 沖津玲奈: "沖津玲那",
};
